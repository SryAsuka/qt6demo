...
# Project:  helloQt.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile helloQt.pro
#############################################################################
...
DISTDIR = /root/Qt6软件开发课程作业/第一周第一次作业/helloQt/.tmp/helloQt1.0.0
LINK          = g++
...
Makefile: helloQt.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
